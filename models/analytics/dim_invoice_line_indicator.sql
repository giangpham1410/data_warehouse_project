...
SELECT
  FARM_FINGERPRINT(
    CONCAT(dim_is_invoice_credit_note.is_invoice_credit_note, '~', dim_delivery_method.delivery_method_key, '~', dim_package_type.package_type_key)
   ) AS dim_invoice_line_indicator
  , dim_is_invoice_credit_note.is_invoice_credit_note
